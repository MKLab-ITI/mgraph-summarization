...
public class LDATopicModelling {
	...
	public static void main(String[] args) throws Exception {
		...
		LDA timePooledmodel = (LDA) LDA.loadModel(timePooledModelFile);
		LDA authorPooledmodel = (LDA) LDA.loadModel(authorPooledModelFile);
		LDA hashtagPooledmodel = (LDA) LDA.loadModel(hashtagPooledModelFile);

...
public class ClusterVector extends Vector implements Comparable<ClusterVector> {
	...
	public ClusterVector(DBObject obj) {
		...
		super((Map<String, Double>) obj.get("vector"));
	...
	@Override
	public int compareTo(ClusterVector other) {
		return Double.compare(this.f_set.size(), other.f_set.size());
	}
